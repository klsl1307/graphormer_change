...
[ -z "${ckpt_path}" ] && ckpt_path="../../checkpoints/PCQM4M-LSC-epoch=015-valid_mae=0.1837.ckpt"
...
default_root_dir=../../exps/pcba_0904/$exp_name/$seed
mkdir -p $default_root_dir

python ../../graphormer/entry_0904.py --num_workers 8 --seed $seed --batch_size $batch_size \
...
do
      ...
      echo "$file"
      echo -e "\n\n\n"
      python ../../graphormer/entry_0904.py --num_workers 8 --seed 1 --batch_size $batch_size \
            --dataset_name ogbg-molpcba \
