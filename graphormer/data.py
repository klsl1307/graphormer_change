...
from wrapper_0904 import MyGraphPropPredDataset, MyPygPCQM4MDataset, MyPygPCQM4Mv2Dataset, MyZINCDataset
...
def get_dataset(dataset_name='abaaba'):
    ...
    elif dataset_name == 'PCQM4Mv2-LSC':
        dataset = {
            'num_class': 1,
            'loss_fn': F.l1_loss,
            'metric': 'mae',
            ...
            'dataset': MyPygPCQM4Mv2Dataset(root='/data/wzh/mol'),
            'max_node': 128,
        }
